...
if (!require(rgexf)) library("rgexf")

#intro OTU table: all numeric, OTUnames as columns
getwd() 
data = read.csv("genus_rarefied.csv")
data <-read.table("clipboard", header = T, sep = "\t") #ONLY in case need to copy/paste dataset in
...
saveAsGEXF = function(g, filepath="proba.gexf")
{
 ...
 saveAsGEXF(g,filepath="C:/Users/mpeipoch/Documents/dataAnalysis/R/Rstudio/biofilm MARC project/proba.gexf")
